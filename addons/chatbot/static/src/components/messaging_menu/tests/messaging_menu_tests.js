...
QUnit.test('chatbots should be in "chat" filter', async function (assert) {
    assert.expect(7);
    ...
    assert.containsOnce(
        ...
        "chatbot should be listed in 'all' tab/filter of messaging menu"
    );
    ...
    assert.containsOnce(
        ...
        "chatbot should be listed in 'chat' tab/filter of messaging menu"
    );
});
