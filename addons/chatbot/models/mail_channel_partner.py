...
class ChannelPartner(models.Model):
    ...
    @api.autovacuum
    def _gc_unpin_chatbot_sessions(self):
        """ Unpin chatbot sessions with no activity for at least one day to
        ...
        self.env.cr.execute("""
            ...
            WHERE id in (
                ...
                WHERE c.channel_type = 'chatbot' AND cp.is_pinned is true AND
